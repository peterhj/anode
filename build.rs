...
fn main() {
  ...
  #[cfg(feature = "gpu")]
  {
    ...
    bindgen::Builder::default()
      ...
      .whitelist_function("anode_gpu_sqrt_flat_map_f32")
      .whitelist_function("anode_gpu_positive_clip_flat_map_f32")
      .whitelist_function("anode_gpu_positive_clip_flat_map_bwd_f32")
      .whitelist_function("anode_gpu_logistic_flat_map_f32")
      .whitelist_function("anode_gpu_logistic_flat_map_bwd_f32")
      ...
      .whitelist_function("anode_gpu_softmax_nd_packed_f32")
      .whitelist_function("anode_gpu_softmax_nd_cat_nll_packed_f32")
      .whitelist_function("anode_gpu_softmax_nd_cat_nll_bwd_packed_f32")
      .whitelist_function("anode_gpu_softmax_nd_cat_nll_bwd_packed_accumulate_f32")
      .generate()
